...
public class CreateSecurityGroupApp {
     ...
     *      (C:\\Users\\Regular\\.aws\\credentials) where the sample code will load the
     *      credentials from.
    ...
    public static void main(String[] args) {
         ...
         * (C:\\Users\\Regular\\.aws\\credentials).
         */
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\Regular\\.aws\\credentials), and is in valid format.",
                    e);
        }
